...
<!-- Begin Menu Choices -->
<div class=menuframe style='border:0' style='align:left'>
<?php
...
<div class=shortspacing style='float:left'><img src=http://rigler.org/rigler-org.png width=50% height=50%></div>
